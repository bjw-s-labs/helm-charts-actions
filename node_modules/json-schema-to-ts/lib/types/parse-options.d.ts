import type { DeserializationPattern, FromSchemaDefaultOptions, FromSchemaOptions, JSONSchema7, JSONSchema7Reference } from "./definitions";
export type IndexReferencesById<SCHEMA_REFERENCES extends readonly JSONSchema7Reference[]> = {
    [REF_SCHEMA in SCHEMA_REFERENCES[number] as REF_SCHEMA["$id"]]: REF_SCHEMA;
};
export type ParseOptions<ROOT_SCHEMA extends JSONSchema7, OPTIONS extends FromSchemaOptions> = {
